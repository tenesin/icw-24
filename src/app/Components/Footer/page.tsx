...
export default function Footer() {
  return (
    <footer className="flex flex-col space-y-4 justify-center m-6">
      ...
      <div className="flex justify-center space-x-5">
        <Link href="https://instagram.com/icw.2024" target='_blank'>
          <Image
        ...
        <Link href="https://www.linkedin.com/company/indonesian-corrosion-week/" target='_blank'>
          <Image
        ...
        <Link href="https://tiktok.com/icw.24" target='_blank'>
          <Image
